...
test.describe('User Story 2| Upload zip function', () => {
    ...
    */
    ...
    Test Step: 
        - Send the "POST | /api/zip" request to upload the file
    ...
    */
    test('Should not allow guest to upload the file is not a zip', async ({ zipSteps, commonSteps }) => {
        ...
        await test.step(`Send the "POST | /api/zip" request to upload the file`, async () => {
    ...
    /*
    Tescase 02: Should allow guest to upload the file is zip file which is not contain any image file
    Precondition:
        - A valid zip file is provided
    Test Step: 
        - Send the POST | /api/zip request to upload the zip file
